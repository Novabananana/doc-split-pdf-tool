...
"""
    ...
    def show_about(self):
        messagebox.showinfo("About", 
            "Docu Split v4.0\n\n"
            "A professional tool for splitting PDF documents and extracting data.\n\n"
            "Features:\n"
            ...
            "- Multi-criteria file naming (up to 4 fields)\n"
            "- Custom filename suffix with separator\n"
            "- Custom CSV output location and filename\n"
            "- CSV includes filename column\n"
